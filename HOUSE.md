...
## Floor Plan (placeholder — correct as needed)

```
                 EAST (front / road side)
                         ↑
         ┌───────────────────────────────┐
         │ Study/ │  Middle Bed           │
  N      │  Bed 3 │  + Comms Cupboard    │     S
  ↑      │(front  ├──────────────────────┤     ↓
         │  ext.) │  Kitchen             │
         ├────────┤                      │
         │ Porch  ├──────────────────────┤
         ...
         ├────────┴──────┴───────────────┤
         │   Main Bedroom                │
         │   (full depth, ex-garage,     │
         │    extended to S boundary)    │
         │   + Walk-in Wardrobe (NAS)    │
         │   + Ensuite                   │
         └───────────────────────────────┘
                         ↓
                 WEST (rear / garden side)
```

> ⚠ Placeholder — room positions and proportions approximate. Correct as needed.
...
- 4-port PoE switch (Reolink cameras — 4 cameras on this switch)
